...
var stickyHeader = new _moduls_StickyHeader__WEBPACK_IMPORTED_MODULE_3__["default"](); // const header = new Header();

jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(jquery__WEBPACK_IMPORTED_MODULE_0___default()(".menu__item").click('.menu__link', function (e) {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".menu__item").removeClass("menu__item--current");
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).addClass("menu__item--current");
}));
